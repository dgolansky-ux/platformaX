# Red-case fixture placeholder for check-mock-adapter-status-truth.mjs
...
- direct CLI invocation: `node scripts/check-mock-adapter-status-truth.mjs` returns non-zero when a violation is planted.
