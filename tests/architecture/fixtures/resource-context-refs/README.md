# Red-case fixture placeholder for check-resource-context-refs.mjs
...
- direct CLI invocation: `node scripts/check-resource-context-refs.mjs` returns non-zero when a violation is planted.
