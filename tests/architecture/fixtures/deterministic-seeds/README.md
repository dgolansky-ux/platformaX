# Red-case fixture placeholder for check-deterministic-seeds.mjs
...
- direct CLI invocation: `node scripts/check-deterministic-seeds.mjs` returns non-zero when a violation is planted.
