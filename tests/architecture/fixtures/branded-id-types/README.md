# Red-case fixture placeholder for check-branded-id-types.mjs
...
- direct CLI invocation: `node scripts/check-branded-id-types.mjs` returns non-zero when a violation is planted.
