# Red-case fixture placeholder for check-features-v2-internal-import.mjs
...
- direct CLI invocation: `node scripts/check-features-v2-internal-import.mjs` returns non-zero when a violation is planted.
