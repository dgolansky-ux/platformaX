# Red-case fixture placeholder for check-presentational-container-boundary.mjs
...
- direct CLI invocation: `node scripts/check-presentational-container-boundary.mjs` returns non-zero when a violation is planted.
