# Red-case fixture placeholder for check-public-hub-source-of-truth.mjs
...
- direct CLI invocation: `node scripts/check-public-hub-source-of-truth.mjs` returns non-zero when a violation is planted.
