# Red-case fixture placeholder for check-correlation-id-boundary.mjs
...
- direct CLI invocation: `node scripts/check-correlation-id-boundary.mjs` returns non-zero when a violation is planted.
