# Red-case fixture placeholder for check-domain-result-errors.mjs
...
- direct CLI invocation: `node scripts/check-domain-result-errors.mjs` returns non-zero when a violation is planted.
