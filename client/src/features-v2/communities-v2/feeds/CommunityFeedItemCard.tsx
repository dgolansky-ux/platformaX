 ...
 * community feed. Shows author (public summary), body, date, feed badge and the
 * distribution trace ("Opublikowano z: {źródło}") for items pushed down from an
 * ancestor community. No comments/reactions in Slice 5, no fake counters, no PII.
 */
...
export function CommunityFeedItemCard({ item }: { item: CommunityFeedItemDTO }) {
