...
export const DOMAIN_REGISTRY: DomainEntry[] = [
  ...
  { name: "content-v2", type: "OWNER_DOMAIN", status: "PARTIAL", owns: "posts, feeds, comments, reactions, topics, read-models", doesNotOwn: "memberships, roles, profiles, friendships" },
  ...
  { name: "events-v2", type: "OWNER_DOMAIN", status: "PARTIAL", owns: "event definitions per owner (profile/community), dates, location, visibility, status", doesNotOwn: "ticketing, external scheduler sync, RSVP runtime" },
  { name: "topics-v2", type: "OWNER_DOMAIN", status: "PARTIAL", owns: "topic definitions per owner (profile/community), slugs, visibility, status", doesNotOwn: "posts, feed, channels" },
  { name: "integrations-v2", type: "OWNER_DOMAIN", status: "PARTIAL", owns: "safe link integrations per owner, URL validation, status", doesNotOwn: "OAuth tokens, API secrets, external sync" },
  { name: "newsletter-chat-v2", type: "OWNER_DOMAIN", status: "PARTIAL", owns: "newsletter chat definitions, broadcast messages, subscriber records (counts only public)", doesNotOwn: "email delivery, push notifications, 1:1 chat" },
