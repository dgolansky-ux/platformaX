...
// PX-ERROR-001-ACK: pre-runtime media boundary still throws raw Error for invariant violations; Result/DomainError migration scheduled with media transport slice. EXC-016.
...
// PX-OWN-002-ACK: pre-runtime public read; viewer-context wiring scheduled when private visibility lands. EXC-016.
