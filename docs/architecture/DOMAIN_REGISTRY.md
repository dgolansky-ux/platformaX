...
> fails the build on drift between this human registry, the YAML registry
> and the TypeScript registry.
...
| communities-v2 | OWNER_DOMAIN | community profile, members, roles, settings, invites, join requests, feed settings | posts, comments, chat, events, modules | public-api, contracts, events | PARTIAL | README, public-api, contracts, ports, store, service, mapper, events, dto, policy, index, tests |
| content-v2 | OWNER_DOMAIN | posts, feeds, comments, reactions, topics, read-models | memberships, roles, profiles, friendships | public-api, contracts, events | PARTIAL | README, public-api, contracts, ports, store, service, mapper, events, dto, policy, index, tests |
| channels | OWNER_DOMAIN | channel definitions, follows, settings | messages, chat history, community roles, community membership | public-api, contracts, events | PARTIAL | README, public-api, contracts, ports, store, service, mapper, events, dto, policy, index, tests |
...
| modules | OWNER_DOMAIN | ModuleDefinition, registry, enablement | actual module business data | public-api, contracts, events | PARTIAL | README, public-api, contracts, definitions, policy, store, service, events, dto, index, tests |
